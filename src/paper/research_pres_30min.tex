...
\title{Term Paper Effective Programming}

\author[Maximilian Maehr]
{
{\bf Maximilian Maehr}\\
...
\begin{frame}
    \begin{figure}
        ...
        \includegraphics[width=\textwidth]{../../out/figures/scatter_home_perc_ger_card_score}
    \end{figure}
\end{frame}
...
\begin{frame}
    \begin{figure}
        \caption{Scatter of percentage of Germans in home team vs. card score}
        \includegraphics[width=\textwidth]{../../out/figures/scatter_away_perc_ger_card_score}
    \end{figure}
\end{frame}
