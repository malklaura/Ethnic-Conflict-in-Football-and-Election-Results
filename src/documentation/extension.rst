...
Navigate to lines 69-72 in *src/data_management/election_data_management/get_elec_mun.py* and comment out the second line to scrape all election data across Germany or change the name of the state accordingly.
...
The football data scraping can be extended by navigating to lines 144-149 in *src/data_management/football_data_management/get_matchday_data.py* and adding further regions to the regions list. An overview of the regions constituting all of German amateur football is given on `<https://fupa.net/>`_.
